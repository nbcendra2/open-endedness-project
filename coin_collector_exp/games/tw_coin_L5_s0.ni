...
The chamber part 0 is some text that varies. The chamber part 0 is "You arrive in a typical kind of place. That is to say, you're in a chamber. You begin to take stock of what's here.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You're now in a laundromat. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go west / go north / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced round of TextWorld! First stop, head west. With that over with, make an attempt to travel north. That done, venture east. And then, head north. Following that, lift th".
The objective part 1 is some text that varies. The objective part 1 is "e coin from the floor of the studio. That's it!".
