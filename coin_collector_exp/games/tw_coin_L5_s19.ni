...
The garage part 0 is some text that varies. The garage part 0 is "I am sorry to announce that you are now in the garage. You begin to take stock of what's here.
...
Test quest0_0 with "go west / go west / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First off, make an attempt to venture west. Then, travel west. If you can accomplish that, ".
The objective part 1 is some text that varies. The objective part 1 is "head south. With that over with, make an effort to move south. Then, retrieve the coin from the floor of the cookhouse. That's it!".
