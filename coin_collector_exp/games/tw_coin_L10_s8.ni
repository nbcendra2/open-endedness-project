...
The r_1 and the r_0 and the r_3 and the r_2 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 and the r_5 are rooms.
...
The attic part 0 is some text that varies. The attic part 0 is "You arrive in an attic. An ordinary kind of place. I guess you better just go and list everything you see here.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You have fallen into the most ordinary of all possible bedrooms. I guess you better just go and list everything you see here.
...
The r_1 and the r_0 and the r_3 and the r_2 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 and the r_5 are rooms.
The r_1 and the r_0 and the r_3 and the r_2 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 and the r_5 are privately-named.
...
Test quest0_0 with "go east / go south / go east / go east / go north / go north / go east / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Your first objective is to go to the east. Following that, attempt to go south. After that, take a tr".
The objective part 1 is some text that varies. The objective part 1 is "ip east. Then, attempt to move east. Okay, and then, make an attempt to go north. Once you manage that, make an attempt to go to the north. After that, move east. Then, venture north. Then, take a tri".
The objective part 2 is some text that varies. The objective part 2 is "p west. With that accomplished, retrieve the coin from the floor of the cookhouse. Alright, thanks!".
