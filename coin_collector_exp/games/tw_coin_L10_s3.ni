...
The r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_7 and the r_8 and the r_9 are rooms.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. A normal kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You're now in a canteen. You begin looking for stuff.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You find yourself in a playroom. A typical kind of place. The room is well lit.
...
The washroom part 0 is some text that varies. The washroom part 0 is "Well I'll be, you are in a place we're calling a washroom. The room is well lit.
...
The r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_7 and the r_8 and the r_9 are rooms.
The r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go east / go east / go south / go west / go west / go south / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your first objective is to venture north. And then, take a trip east. Then, move east. After that, make an effor".
The objective part 1 is some text that varies. The objective part 1 is "t to take a trip south. Okay, and then, take a trip west. And then, make an attempt to take a trip west. And then, make an effort to head south. With that done, make an attempt to go to the south. If ".
The objective part 2 is some text that varies. The objective part 2 is "you can succeed at that, attempt to head south. With that done, retrieve the coin from the floor of the washroom. And if you do that, you're the winner!".
