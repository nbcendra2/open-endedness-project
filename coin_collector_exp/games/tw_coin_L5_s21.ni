...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a canteen. An ordinary one. Okay, just remember what you're here to do, and everything will go great.
...
The closet part 0 is some text that varies. The closet part 0 is "Well, here we are in a closet. You begin to take stock of what's here.
...
Test quest0_0 with "go east / go north / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, travel east. Okay, and then, travel north. And then, go north. Once you accomplish that, mak".
The objective part 1 is some text that varies. The objective part 1 is "e an effort to go west. And then, retrieve the coin from the floor of the sauna. Alright, thanks!".
