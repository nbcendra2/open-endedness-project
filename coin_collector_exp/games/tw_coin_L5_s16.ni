...
The steam room part 0 is some text that varies. The steam room part 0 is "You've just shown up in a steam room. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "A rusty sign tells you that you are now in the cubicle. Okay, just remember what you're here to do, and everything will go great.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First off, make an attempt to venture west. With that done, head sou".
The objective part 1 is some text that varies. The objective part 1 is "th. And then, go east. And then, make an attempt to venture east. If you can do that, lift the coin from the floor of the kitchenette. Alright, thanks!".
