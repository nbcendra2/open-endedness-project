...
The r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_3 and the r_6 are rooms.
...
The washroom part 0 is some text that varies. The washroom part 0 is "Well, here we are in the washroom. I guess you better just go and list everything you see here.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You are in a laundry place. A standard kind of place. I guess you better just go and list everything you see here.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've stumbled into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the cookhouse.
...
The r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_3 and the r_6 are rooms.
The r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_3 and the r_6 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go north / go west / go south / go south / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to go south. Next, make an attempt to venture east.".
The objective part 1 is some text that varies. The objective part 1 is " And then, try to go north. If you can get through with that, attempt to travel north. Then, head west. And then, make an attempt to venture south. With that over with, move south. Then, try to go to ".
The objective part 2 is some text that varies. The objective part 2 is "the west. With that over with, go to the west. And then, retrieve the coin from the floor of the cookhouse. Once that's all handled, you can stop!".
