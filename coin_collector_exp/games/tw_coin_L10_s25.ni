...
The r_0 and the r_1 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 are rooms.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've moved into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the bathroom.
...
The workshop part 0 is some text that varies. The workshop part 0 is "This might come as a shock to you, but you've just come into a workshop. Okay, just remember what you're here to do, and everything will go great.
...
The r_0 and the r_1 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 are rooms.
The r_0 and the r_1 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 are privately-named.
...
Test quest0_0 with "go west / go north / go east / go east / go east / go north / go west / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced session of TextWorld! First, it would be good if you could make an attempt to go west. If you can succeed at that, take a trip north. And then, travel east. Then, vent".
The objective part 1 is some text that varies. The objective part 1 is "ure east. Okay, and then, attempt to travel east. Following that, make an attempt to venture north. And then, go west. That done, venture south. Next, try to head east. With that accomplished, pick up".
The objective part 2 is some text that varies. The objective part 2 is " the coin from the floor of the study. And once you've done that, you win!".
