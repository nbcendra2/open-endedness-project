...
The canteen part 0 is some text that varies. The canteen part 0 is "You've just shown up in a canteen. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0_0 with "go east / go east / go north / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing session of TextWorld! First step, venture east. Then, make an attempt to travel east. With that over with, make an attempt to venture north. Then, travel east. Followi".
The objective part 1 is some text that varies. The objective part 1 is "ng that, retrieve the coin from the floor of the chamber. Got that? Good!".
