...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You're now in a cookhouse. Okay, just remember what you're here to do, and everything will go great.
...
The study part 0 is some text that varies. The study part 0 is "You are in a study. A normal one. Let's see what's in here.
...
Test quest0_0 with "go west / go west / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing episode of TextWorld! Here is how to play! First of all, go to the west. Then, make an attempt to move west. Next, venture west. And then, venture north. If you can fi".
The objective part 1 is some text that varies. The objective part 1 is "nish that, lift the coin from the floor of the study. Once that's all handled, you can stop!".
