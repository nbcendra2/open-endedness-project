...
The r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_0 and the r_1 and the r_6 and the r_7 are rooms.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You make a grand eccentric entrance into a canteen. You begin looking for stuff.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just shown up in the dish-pit.
...
The studio part 0 is some text that varies. The studio part 0 is "You have fallen into the most typical of all possible studios. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_0 and the r_1 and the r_6 and the r_7 are rooms.
The r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_0 and the r_1 and the r_6 and the r_7 are privately-named.
...
Test quest0_0 with "go south / go south / go west / go south / go west / go south / go south / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First of all, you could, like, head south. With that accomplished, make an attempt to travel south. And then, attempt to go west. And then, move so".
The objective part 1 is some text that varies. The objective part 1 is "uth. And then, attempt to head west. That done, make an effort to head south. And then, go to the south. Then, take a trip south. Then, make an effort to go to the west. After that, pick up the coin f".
The objective part 2 is some text that varies. The objective part 2 is "rom the floor of the dish-pit. That's it!".
