...
The chamber part 0 is some text that varies. The chamber part 0 is "You arrive in a chamber. A normal one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go north / go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing episode of TextWorld! First of all, you could, like, go to the north. And then, go to the east. With that over with, try to head south. After that, make an effort to h".
The objective part 1 is some text that varies. The objective part 1 is "ead east. And then, pick-up the coin from the floor of the cookhouse. Got that? Good!".
