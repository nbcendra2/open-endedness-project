...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. You begin looking for stuff.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You arrive in a cookhouse. A normal one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0_0 with "go south / go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! First off, make an attempt to take a trip south. With that done, make an effort to venture east. Once y".
The objective part 1 is some text that varies. The objective part 1 is "ou get around to doing that, go south. And then, go to the east. Then, retrieve the coin from the floor of the lounge. And if you do that, you're the winner!".
