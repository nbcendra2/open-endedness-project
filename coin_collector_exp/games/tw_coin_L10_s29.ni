...
The shower part 0 is some text that varies. The shower part 0 is "I am sorry to announce that you are now in the shower. You start to take note of what's in the room.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. An usual one. You begin looking for stuff.
...
Test quest0_0 with "go west / go west / go west / go south / go east / go north / go west / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could go west. And then, move west. That done, go west. Then, try to go ".
The objective part 1 is some text that varies. The objective part 1 is "to the south. With that over with, attempt to go to the east. With that accomplished, venture north. And then, make an attempt to travel west. Okay, and then, take a trip west. Then, go to the south. ".
The objective part 2 is some text that varies. The objective part 2 is "Once you accomplish that, recover the coin from the floor of the spare room. And if you do that, you're the winner!".
