...
The r_2 and the r_1 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 are rooms.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Ah, the bedroom. This is some kind of bedroom, really great normal vibes in this place, a wonderful normal atmosphere. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You have come into the most ordinary of all possible saunas.
...
The r_2 and the r_1 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 are rooms.
The r_2 and the r_1 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 are privately-named.
...
Test quest0_0 with "go south / go east / go east / go east / go south / go east / go east / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, make an effort to travel south. With that done, take a trip east. Once yo".
The objective part 1 is some text that varies. The objective part 1 is "u finish that, make an attempt to go to the east. Okay, and then, travel east. Then, go south. Then, make an attempt to go to the east. With that accomplished, go to the east. Once you succeed at that".
The objective part 2 is some text that varies. The objective part 2 is ", go to the north. Then, attempt to head west. After that, pick up the coin from the floor of the workshop. Alright, thanks!".
