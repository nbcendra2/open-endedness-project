...
The r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_0 and the r_6 and the r_9 are rooms.
...
The office part 0 is some text that varies. The office part 0 is "You arrive in an office. An ordinary kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. A normal kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_0 and the r_6 and the r_9 are rooms.
The r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_0 and the r_6 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go west / go west / go north / go north / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to attempt to move south. With that done, attempt t".
The objective part 1 is some text that varies. The objective part 1 is "o go east. And then, take a trip north. Once you do that, make an effort to travel west. With that accomplished, take a trip west. Okay, and then, go to the north. And then, make an effort to move nor".
The objective part 2 is some text that varies. The objective part 2 is "th. Then, try to travel east. After that, venture south. If you can get around to doing that, pick up the coin from the floor of the attic. Got that? Good!".
