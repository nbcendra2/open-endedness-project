...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Guess what, you are in the place we're calling the bathroom. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The office part 0 is some text that varies. The office part 0 is "You're not going to believe this, but you've just entered an office. You can barely contain your excitement.
...
Test quest0_0 with "go north / go north / go east / go east / go south / go west / go north / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound game of TextWorld! Here is your task for today. First step, venture north. And then, travel north. And then, venture east. Following that, attempt to go to the east. Tha".
The objective part 1 is some text that varies. The objective part 1 is "t done, go to the south. And then, attempt to go west. Next, venture north. Okay, and then, head north. After that, take a trip west. And then, lift the coin from the floor of the office. And if you d".
The objective part 2 is some text that varies. The objective part 2 is "o that, you're the winner!".
