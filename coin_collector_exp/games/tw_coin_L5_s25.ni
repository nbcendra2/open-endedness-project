...
The shower part 0 is some text that varies. The shower part 0 is "Ah, the shower. This is some kind of shower, really great typical vibes in this place, a wonderful typical atmosphere. And now, well, you're in it. You begin to take stock of what's in the room.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Well I'll be, you are in a place we're calling a bathroom. I guess you better just go and list everything you see here.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You are in a workshop. It seems to be pretty standard here.
...
Test quest0_0 with "go west / go north / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be a great idea if you could make an attempt to go west. If you can succeed at that, tak".
The objective part 1 is some text that varies. The objective part 1 is "e a trip north. And then, travel east. Then, venture east. Okay, and then, retrieve the coin from the floor of the workshop. That's it!".
