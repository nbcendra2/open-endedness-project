...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've seen better cookhouses, but at least this one seems pretty usual.
...
The study part 0 is some text that varies. The study part 0 is "You've just sauntered into a study. You begin to take stock of what's here.
...
Test quest0_0 with "go west / go west / go south / go south / go west / go south / go west / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make an attempt to venture west. Then, travel west. If you can accomplish that, head south".
The objective part 1 is some text that varies. The objective part 1 is ". With that over with, make an effort to move south. Then, attempt to head west. And then, move south. That done, make an effort to move west. Then, venture south. With that accomplished, attempt to g".
The objective part 2 is some text that varies. The objective part 2 is "o to the south. With that accomplished, recover the coin from the floor of the study. And once you've done that, you win!".
