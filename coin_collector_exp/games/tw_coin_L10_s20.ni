...
The r_4 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_1 and the r_2 and the r_5 are rooms.
...
The study part 0 is some text that varies. The study part 0 is "I never took you for the sort of person who would show up in a study, but I guess I was wrong. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The r_4 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_1 and the r_2 and the r_5 are rooms.
The r_4 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_1 and the r_2 and the r_5 are privately-named.
...
Test quest0_0 with "go north / go north / go north / go east / go north / go north / go west / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! First of all, head north. With that accomplished, go to the north. Then, make an effort to go north. Then, travel east. And then, make an effort to mo".
The objective part 1 is some text that varies. The objective part 1 is "ve north. Once you succeed at that, go to the north. With that accomplished, venture west. Once you get around to doing that, move north. After that, make an attempt to venture west. Then, retrieve th".
The objective part 2 is some text that varies. The objective part 2 is "e coin from the floor of the playroom. Got that? Good!".
