...
The r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_0 and the r_7 and the r_8 and the r_9 are rooms.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You are in a chamber. A typical one. Let's see what's in here.
...
The garage part 0 is some text that varies. The garage part 0 is "You've entered an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the garage. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You have moved into the most ordinary of all possible dish-pits. You can barely contain your excitement.
...
The r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_0 and the r_7 and the r_8 and the r_9 are rooms.
The r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_0 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go east / go south / go east / go north / go west / go south / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting episode of TextWorld! Here is your task for today. Your first objective is to go to the north. And then, go to the east. With that over with, try to head south. After that,".
The objective part 1 is some text that varies. The objective part 1 is " make an effort to head east. And then, make an attempt to go north. Then, take a trip west. Then, try to venture south. Then, make an attempt to move south. Following that, take a trip south. That do".
The objective part 2 is some text that varies. The objective part 2 is "ne, pick up the coin from the floor of the dish-pit. Got that? Good!".
