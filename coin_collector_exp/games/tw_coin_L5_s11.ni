...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in an ordinary kind of place. That is to say, you're in a kitchen. The room is well lit.
...
Test quest0_0 with "go south / go east / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could attempt to move south. With that done, attempt to go east. And the".
The objective part 1 is some text that varies. The objective part 1 is "n, take a trip north. Once you do that, make an effort to travel west. With that accomplished, pick up the coin from the floor of the office. Once that's all handled, you can stop!".
