...
The r_0 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_2 are rooms.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've just sauntered into a laundromat. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You've entered a washroom. You start to take note of what's in the room.
...
The spare room part 0 is some text that varies. The spare room part 0 is "Well, here we are in a spare room. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The launderette part 0 is some text that varies. The launderette part 0 is "You're now in a launderette. Let's see what's in here.
...
The r_0 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_2 are rooms.
The r_0 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_2 are privately-named.
...
Test quest0_0 with "go west / go north / go north / go east / go north / go west / go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to head west. And then, attempt to travel north. Once you manage that, go north.".
The objective part 1 is some text that varies. The objective part 1 is " And then, make an attempt to venture east. After that, take a trip north. Following that, take a trip west. After that, go to the west. And then, head west. And then, make an attempt to go to the wes".
The objective part 2 is some text that varies. The objective part 2 is "t. After that, pick up the coin from the floor of the basement. Got that? Good!".
