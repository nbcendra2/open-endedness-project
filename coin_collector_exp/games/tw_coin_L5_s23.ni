...
The cookery part 0 is some text that varies. The cookery part 0 is "Guess what, you are in the place we're calling the cookery. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First off, if it's not too much trouble, I need you to make an effort to travel south. With that ".
The objective part 1 is some text that varies. The objective part 1 is "done, take a trip east. Once you finish that, make an attempt to go to the east. Okay, and then, travel east. Then, pick-up the coin from the floor of the dish-pit. Alright, thanks!".
