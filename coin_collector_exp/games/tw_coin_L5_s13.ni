...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've just walked into a laundromat. You begin to take stock of what's in the room.
...
The closet part 0 is some text that varies. The closet part 0 is "Well, here we are in the closet. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! First of all, make an effort to head west. With that done, move south. And then, head east. And then, m".
The objective part 1 is some text that varies. The objective part 1 is "ove east. Next, recover the coin from the floor of the bar. Alright, thanks!".
