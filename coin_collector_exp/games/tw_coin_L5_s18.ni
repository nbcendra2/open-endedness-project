...
The workshop part 0 is some text that varies. The workshop part 0 is "Well I'll be, you are in a place we're calling a workshop. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, venture north. And then, travel north. And then, venture east. Following that, attempt to go ".
The objective part 1 is some text that varies. The objective part 1 is "to the east. That done, retrieve the coin from the floor of the chamber. Alright, thanks!".
