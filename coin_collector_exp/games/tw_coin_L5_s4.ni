...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Guess what, you are in a place we're calling a cookhouse. The room is well lit.
...
Test quest0_0 with "go east / go east / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, you could, like, travel east. With that over with, venture east. And then, make an ".
The objective part 1 is some text that varies. The objective part 1 is "attempt to venture north. That done, take a trip west. With that accomplished, pick up the coin from the floor of the cookhouse. That's it!".
