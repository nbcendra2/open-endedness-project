...
The salon part 0 is some text that varies. The salon part 0 is "You are in a salon. A normal kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0_0 with "go east / go south / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, make an attempt to head east. Following that, make an attempt to venture south. The".
The objective part 1 is some text that varies. The objective part 1 is "n, make an effort to take a trip south. And then, make an effort to travel south. If you can manage that, pick-up the coin from the floor of the office. That's it!".
