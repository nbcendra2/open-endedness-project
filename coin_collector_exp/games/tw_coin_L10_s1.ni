...
The r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_6 and the r_0 and the r_3 and the r_8 and the r_9 are rooms.
...
The basement part 0 is some text that varies. The basement part 0 is "Guess what, you are in a place we're calling a basement. The room is well lit.
...
The closet part 0 is some text that varies. The closet part 0 is "Well I'll be, you are in the place we're calling the closet. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_6 and the r_0 and the r_3 and the r_8 and the r_9 are rooms.
The r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_6 and the r_0 and the r_3 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go north / go west / go north / go east / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound game of TextWorld! Here is your task for today. First of all, you could, like, make an effort to move south. And then, take a trip east. Then, try to go north. Okay, and".
The objective part 1 is some text that varies. The objective part 1 is " then, make an effort to head north. And then, head west. With that over with, attempt to move north. That done, go to the east. Then, move north. After that, venture north. Next, pick up the coin fro".
The objective part 2 is some text that varies. The objective part 2 is "m the floor of the bathroom. Once that's all handled, you can stop!".
