...
The scullery part 0 is some text that varies. The scullery part 0 is "You've just sauntered into a scullery. You start to take note of what's in the room.
...
The shower part 0 is some text that varies. The shower part 0 is "You are in a shower. An ordinary one. You begin to take stock of what's in the room.
...
Test quest0_0 with "go east / go north / go west / go south / go east / go north / go west / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First of all, travel east. With that over with, head north. Then, make an effort to travel west. Then, venture south. ".
The objective part 1 is some text that varies. The objective part 1 is "And then, make an effort to move east. Then, move north. That done, make an attempt to go west. With that done, travel west. Once you manage that, try to head south. Then, retrieve the coin from the f".
The objective part 2 is some text that varies. The objective part 2 is "loor of the garage. Alright, thanks!".
