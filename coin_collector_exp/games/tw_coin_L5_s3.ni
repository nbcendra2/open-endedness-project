...
The basement part 0 is some text that varies. The basement part 0 is "I am sorry to announce that you are now in the basement. You begin looking for stuff.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a standard kind of place. That is to say, you're in a kitchenette. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0_0 with "go north / go east / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First off, venture north. And then, take a trip east. Then, move east. After that, make an effort to take a trip south. Okay, and then, pick up the coin from the floor of the lau".
The objective part 1 is some text that varies. The objective part 1 is "ndromat. Once that's all handled, you can stop!".
