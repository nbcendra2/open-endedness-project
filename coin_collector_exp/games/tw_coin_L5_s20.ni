...
The r_4 and the r_3 and the r_0 and the r_1 and the r_2 are rooms.

Understand "garage" as r_4.
The internal name of r_4 is "garage".
The printed name of r_4 is "-= Garage =-".
The garage part 0 is some text that varies. The garage part 0 is "You arrive in a garage. A normal one. You start to take note of what's in the room.
...
The r_4 and the r_3 and the r_0 and the r_1 and the r_2 are rooms.
The r_4 and the r_3 and the r_0 and the r_1 and the r_2 are privately-named.
...
Test quest0_0 with "go north / go north / go north / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing session of TextWorld! Here is how to play! First of all, you could, like, head north. With that accomplished, go to the north. Then, make an effort to go north. Then, ".
The objective part 1 is some text that varies. The objective part 1 is "travel east. And then, pick up the coin from the floor of the garage. Got that? Good!".
