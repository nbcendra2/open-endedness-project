...
The cellar part 0 is some text that varies. The cellar part 0 is "You are in a cellar. It seems to be pretty usual here.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to go west. And then, move west. That done, go west. Then, try to go to the sout".
The objective part 1 is some text that varies. The objective part 1 is "h. With that over with, pick-up the coin from the floor of the workshop. Alright, thanks!".
