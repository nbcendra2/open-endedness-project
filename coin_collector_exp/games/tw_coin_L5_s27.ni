...
The studio part 0 is some text that varies. The studio part 0 is "Look at that sign! What does it say? It says Welcome to the studio? Well that's cool. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
Test quest0_0 with "go north / go west / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to make an effort to move north. And then, make an attempt to move west. After t".
The objective part 1 is some text that varies. The objective part 1 is "hat, try to head west. And then, travel north. With that done, retrieve the coin from the floor of the studio. And once you've done that, you win!".
