...
Test quest0_0 with "go north / go east / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First stop, try to venture north. After that, head east. That done, go to the east. Next, attempt to travel north. And then, p".
The objective part 1 is some text that varies. The objective part 1 is "ick up the coin from the floor of the bar. And if you do that, you're the winner!".
