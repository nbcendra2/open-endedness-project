...
The r_0 and the r_1 and the r_3 and the r_2 and the r_5 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 are rooms.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You find yourself in a chamber. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The studio part 0 is some text that varies. The studio part 0 is "You have fallen into the most typical of all possible studios.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a cubicle. A standard one. I guess you better just go and list everything you see here.
...
The r_0 and the r_1 and the r_3 and the r_2 and the r_5 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 are rooms.
The r_0 and the r_1 and the r_3 and the r_2 and the r_5 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go west / go north / go east / go north / go east / go north / go east / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First step, head west. With that over with, make an attempt to travel north. That done, venture east. And then, head n".
The objective part 1 is some text that varies. The objective part 1 is "orth. Following that, make an effort to take a trip east. If you can get around to doing that, try to head north. After that, make an attempt to head east. Following that, try to head east. Okay, and ".
The objective part 2 is some text that varies. The objective part 2 is "then, make an attempt to venture east. Then, pick up the coin from the floor of the cubicle. And if you do that, you're the winner!".
