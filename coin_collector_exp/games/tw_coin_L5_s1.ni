...
The studio part 0 is some text that varies. The studio part 0 is "I am required to announce that you are now in the studio.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've just sauntered into a cookhouse. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You find yourself in a dish-pit. A typical one. The room is well lit.
...
Test quest0_0 with "go south / go east / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, make an effort to move south. And then, take a trip east. Then, try to go north. Okay, and th".
The objective part 1 is some text that varies. The objective part 1 is "en, make an effort to head north. And then, retrieve the coin from the floor of the cookery. Got that? Good!".
