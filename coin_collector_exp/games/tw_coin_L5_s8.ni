...
The study part 0 is some text that varies. The study part 0 is "Look at you, bigshot, walking into a study like it isn't some huge deal. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "I just think it's awesome that you're in a recreation zone now. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go east / go south / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, go to the east. Following that, attempt to go south. After that, take a trip ".
The objective part 1 is some text that varies. The objective part 1 is "east. Then, attempt to move east. Okay, and then, pick-up the coin from the floor of the recreation zone. And if you do that, you're the winner!".
