...
The r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_8 and the r_9 are rooms.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Well I'll be, you are in the place we're calling the cookhouse. I guess you better just go and list everything you see here.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You have moved into a kitchenette. Not the kitchenette you'd expect. No, this is a kitchenette. You begin to take stock of what's here.
...
The closet part 0 is some text that varies. The closet part 0 is "You are in a closet. A standard one. You begin to take stock of what's in the room.
...
The study part 0 is some text that varies. The study part 0 is "You have come into a study. Not the study you'd expect. No, this is a study. You start to take note of what's in the room.
...
The r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_8 and the r_9 are rooms.
The r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go south / go east / go north / go east / go east / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, make an attempt to take a trip south. With that done, make an effort to venture east. Once y".
The objective part 1 is some text that varies. The objective part 1 is "ou get around to doing that, go south. And then, go to the east. Then, make an effort to head north. And then, head east. And then, venture east. That done, take a trip north. Next, attempt to venture".
The objective part 2 is some text that varies. The objective part 2 is " north. After that, pick up the coin from the floor of the study. That's it!".
