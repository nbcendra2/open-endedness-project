...
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_8 and the r_7 and the r_5 and the r_6 and the r_9 are rooms.

Understand "cookery" as r_1.
The internal name of r_1 is "cookery".
The printed name of r_1 is "-= Cookery =-".
The cookery part 0 is some text that varies. The cookery part 0 is "Guess what, you are in the place we're calling the cookery. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You're now in a cookhouse. I guess you better just go and list everything you see here.
...
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_8 and the r_7 and the r_5 and the r_6 and the r_9 are rooms.
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_8 and the r_7 and the r_5 and the r_6 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go east / go north / go west / go north / go north / go north / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound game of TextWorld! Here is how to play! First stop, travel east. With that over with, venture east. And then, make an attempt to venture north. That done, take a trip west.".
The objective part 1 is some text that varies. The objective part 1 is " With that accomplished, make an attempt to take a trip north. Following that, make an attempt to go to the north. And then, take a trip north. And then, head east. After that, attempt to head south. ".
The objective part 2 is some text that varies. The objective part 2 is "Then, retrieve the coin from the floor of the scullery. That's it!".
