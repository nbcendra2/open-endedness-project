...
The attic part 0 is some text that varies. The attic part 0 is "Of every attic you could have sauntered into, you had to show up in an ordinary one. The room is well lit.
...
Test quest0_0 with "go north / go west / go west / go north / go west / go west / go south / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting episode of TextWorld! Your first objective is to make an effort to move north. And then, make an attempt to move west. After that, try to head west. And then, travel north.".
The objective part 1 is some text that varies. The objective part 1 is " With that done, head west. With that over with, try to head west. And then, attempt to go south. And then, make an effort to go to the east. If you can succeed at that, go south. Following that, pick".
The objective part 2 is some text that varies. The objective part 2 is " up the coin from the floor of the study. And once you've done that, you win!".
