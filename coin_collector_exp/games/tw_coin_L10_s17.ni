...
The r_1 and the r_0 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_2 and the r_3 are rooms.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. It seems to be pretty usual here.
...
The r_1 and the r_0 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_2 and the r_3 are rooms.
The r_1 and the r_0 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_2 and the r_3 are privately-named.
...
Test quest0_0 with "go east / go south / go south / go south / go east / go south / go west / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First step, make an attempt to head east. Following that, make an attempt to ventur".
The objective part 1 is some text that varies. The objective part 1 is "e south. Then, make an effort to take a trip south. And then, make an effort to travel south. If you can manage that, attempt to go east. Then, go to the south. Following that, attempt to take a trip ".
The objective part 2 is some text that varies. The objective part 2 is "west. And then, attempt to venture south. Next, travel east. And then, lift the coin from the floor of the cookery. That's it!".
