...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your first objective is to travel east. With that over with, head north. Then, make an effort to travel west. Then, venture south. And then, lift t".
The objective part 1 is some text that varies. The objective part 1 is "he coin from the floor of the laundry place. Once that's all handled, you can stop!".
