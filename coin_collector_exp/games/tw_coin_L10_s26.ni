...
The r_1 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 are rooms.
...
The cellar part 0 is some text that varies. The cellar part 0 is "This is going to sound unbelievable, but you've just entered a cellar.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You find yourself in a dish-pit. A typical one. You begin to take stock of what's in the room.
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in an ordinary kind of place. That is to say, you're in a basement. You can barely contain your excitement.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Of every cookhouse you could have shown up in, you had to saunter into a standard one. You begin to take stock of what's in the room.
...
The r_1 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 are rooms.
The r_1 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 are privately-named.
...
Test quest0_0 with "go south / go west / go north / go west / go west / go north / go west / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First off, move south. Once you get around to doing that, head west. And then, make an attempt to take a trip north. And then, head west. And then, a".
The objective part 1 is some text that varies. The objective part 1 is "ttempt to head west. Once you finish that, make an attempt to take a trip north. With that accomplished, venture west. And then, attempt to head south. After that, make an attempt to go west. Then, re".
The objective part 2 is some text that varies. The objective part 2 is "cover the coin from the floor of the cookhouse. Got that? Good!".
