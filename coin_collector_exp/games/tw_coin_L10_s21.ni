...
The r_1 and the r_0 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_2 and the r_9 are rooms.

Understand "kitchen" as r_1.
The internal name of r_1 is "kitchen".
The printed name of r_1 is "-= Kitchen =-".
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well how about that, you are in a place we're calling a kitchen. Let's see what's in here.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've just walked into a sauna. Okay, just remember what you're here to do, and everything will go great.
...
The workshop part 0 is some text that varies. The workshop part 0 is "Welcome to the workshop. You start to take note of what's in the room.
...
The study part 0 is some text that varies. The study part 0 is "Of every study you could have walked into, you had to saunter into a standard one.
...
The salon part 0 is some text that varies. The salon part 0 is "Ah, the salon. This is some kind of salon, really great standard vibes in this place, a wonderful standard atmosphere. You start to take note of what's in the room.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You're now in the cookhouse. You begin to take stock of what's here.
...
The chamber part 0 is some text that varies. The chamber part 0 is "Guess what, you are in the place we're calling the chamber. Let's see what's in here.
...
The r_1 and the r_0 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_2 and the r_9 are rooms.
The r_1 and the r_0 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_2 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go north / go north / go west / go north / go east / go south / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First, it would be a great idea if you could travel east. Okay, and then, travel north. And".
The objective part 1 is some text that varies. The objective part 1 is " then, go north. Once you accomplish that, make an effort to go west. And then, attempt to venture north. With that done, attempt to go east. Following that, go to the south. Then, venture west. If yo".
The objective part 2 is some text that varies. The objective part 2 is "u can do that, venture south. And then, pick-up the coin from the floor of the chamber. And once you've done that, you win!".
