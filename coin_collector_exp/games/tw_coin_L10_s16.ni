...
The canteen part 0 is some text that varies. The canteen part 0 is "You are in a canteen. You can barely contain your excitement.
...
Test quest0_0 with "go west / go south / go east / go east / go east / go north / go west / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your first objective is to make an attempt to venture west. With that done, head south. And then, go east. And then, make an attempt to venture eas".
The objective part 1 is some text that varies. The objective part 1 is "t. If you can do that, attempt to move east. After that, try to go to the north. Okay, and then, head west. Then, attempt to head south. Following that, try to venture south. After that, pick up the c".
The objective part 2 is some text that varies. The objective part 2 is "oin from the floor of the basement. That's it!".
