...
The cellar part 0 is some text that varies. The cellar part 0 is "I am pleased to announce that you are now in the cellar. You begin looking for stuff.
...
The parlor part 0 is some text that varies. The parlor part 0 is "I never took you for the sort of person who would show up in a parlor, but I guess I was wrong.
...
The garage part 0 is some text that varies. The garage part 0 is "You are in a garage. An ordinary one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a typical kind of place. That is to say, you're in a cubicle. You begin to take stock of what's here.
...
Test quest0_0 with "go east / go east / go north / go east / go north / go west / go south / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, venture east. Then, make an attempt to travel east. With tha".
The objective part 1 is some text that varies. The objective part 1 is "t over with, make an attempt to venture north. Then, travel east. Following that, take a trip north. Following that, make an attempt to take a trip west. With that accomplished, venture south. Then, g".
The objective part 2 is some text that varies. The objective part 2 is "o west. If you can succeed at that, move west. After that, pick-up the coin from the floor of the cubicle. Alright, thanks!".
