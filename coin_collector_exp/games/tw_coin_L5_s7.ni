...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! First off, go south. Next, make an attempt to venture east. And then, try to go north. If you can ".
The objective part 1 is some text that varies. The objective part 1 is "get through with that, attempt to travel north. Then, recover the coin from the floor of the bedroom. And if you do that, you're the winner!".
