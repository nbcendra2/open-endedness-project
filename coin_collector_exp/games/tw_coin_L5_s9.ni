...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. An usual kind of place. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, head south. With that accomplished, make an attempt to travel south. And then, atte".
The objective part 1 is some text that varies. The objective part 1 is "mpt to go west. And then, move south. And then, retrieve the coin from the floor of the canteen. That's it!".
