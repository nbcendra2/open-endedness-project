...
The shower part 0 is some text that varies. The shower part 0 is "You have fallen into a shower. Not the shower you'd expect. No, this is a shower.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is your task for today. First stop, head west. Then, make an attempt to take a trip north. And the".
The objective part 1 is some text that varies. The objective part 1 is "n, make an attempt to head east. Then, make an effort to travel north. And then, recover the coin from the floor of the bedchamber. Once that's all handled, you can stop!".
