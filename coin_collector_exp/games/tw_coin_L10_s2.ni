...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Well, here we are in a bedchamber. I guess you better just go and list everything you see here.
...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
Test quest0_0 with "go north / go east / go east / go north / go west / go south / go west / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First step, try to venture north. After that, head east. That done, ".
The objective part 1 is some text that varies. The objective part 1 is "go to the east. Next, attempt to travel north. And then, travel west. That done, head south. With that accomplished, make an effort to head west. After that, make an effort to take a trip north. Then,".
The objective part 2 is some text that varies. The objective part 2 is " attempt to head west. And then, pick up the coin from the floor of the cubicle. And once you've done that, you win!".
