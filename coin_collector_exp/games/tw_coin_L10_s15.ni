...
The r_0 and the r_1 and the r_3 and the r_2 and the r_6 and the r_7 and the r_8 and the r_9 and the r_4 and the r_5 are rooms.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You make a grand eccentric entrance into a playroom. Okay, just remember what you're here to do, and everything will go great.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "Of every laundromat you could have walked into, you had to walk into a typical one.
...
The r_0 and the r_1 and the r_3 and the r_2 and the r_6 and the r_7 and the r_8 and the r_9 and the r_4 and the r_5 are rooms.
The r_0 and the r_1 and the r_3 and the r_2 and the r_6 and the r_7 and the r_8 and the r_9 and the r_4 and the r_5 are privately-named.
...
Test quest0_0 with "go west / go north / go east / go north / go north / go north / go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First thing I need you to do is to head west. Then, make an attempt to take a trip north. And then, make an attempt to".
The objective part 1 is some text that varies. The objective part 1 is " head east. Then, make an effort to travel north. And then, go north. If you can get through with that, make an effort to venture north. Then, move west. With that done, go west. After that, go west. ".
The objective part 2 is some text that varies. The objective part 2 is "Following that, retrieve the coin from the floor of the playroom. Once that's all handled, you can stop!".
