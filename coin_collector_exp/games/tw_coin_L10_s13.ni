...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You find yourself in a laundromat. A standard one. The room is well lit.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You are in an usual kind of place. That is to say, you're in a canteen. Okay, just remember what you're here to do, and everything will go great.
...
The studio part 0 is some text that varies. The studio part 0 is "Well, here we are in a studio. The room is well lit.
...
Test quest0_0 with "go west / go south / go east / go east / go east / go east / go north / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing game of TextWorld! First off, make an effort to head west. With that done, move south. And then, head east. And then, move east. Next, make an attempt to venture ea".
The objective part 1 is some text that varies. The objective part 1 is "st. Then, make an attempt to go to the east. Next, make an attempt to go north. And then, attempt to venture west. And then, make an attempt to move south. With that done, pick up the coin from the fl".
The objective part 2 is some text that varies. The objective part 2 is "oor of the kitchen. Got that? Good!".
